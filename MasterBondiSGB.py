...
from src.getMiscFuncs import getIVsAndNames, getExpressions
        ...
        for h in range(0, len(rcrits)):
            ...
            for l in range(0, len(gammas)):
                ...
                if theory == "GR":
                    ...
                    filename = "iData_" + accword + "_" + theory + "_z" + str(zeta) + "_p" + str(power) + "_rcrit" + str(rcrit) + "_g" + str(g) + "_N" + str(N) + ".csv"
